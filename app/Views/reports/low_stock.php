                ...
                <?php else: ?>
                    <?php foreach ($items as $item): ?>
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/60">
                            ...
                            <td data-label="Quantidade" class="px-4 py-3 text-right text-rose-600 dark:text-rose-400"><?php echo (int)$item['quantidade']; ?></td>
                            <td data-label="Minimo" class="px-4 py-3 text-right"><?php echo (int)$item['min_estoque']; ?></td>
                            <td data-label="Custo unitario" class="px-4 py-3 text-right">R$ <?php echo number_format((float)$item['custo_unitario'], 2, ',', '.'); ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
