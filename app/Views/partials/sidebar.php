...
<aside
    id="app-sidebar"
    data-tour="main-nav"
    class="app-sidebar fixed inset-y-0 left-0 z-40 w-64 -translate-x-full transform px-4 py-6 text-sm shadow-xl transition duration-200 ease-out md:static md:z-0 md:translate-x-0 md:shadow-none"
