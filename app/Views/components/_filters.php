...
?>
<form method="GET" action="/components" data-tour="components-filters" class="app-filters app-panel space-y-4">
    ...
    <div class="flex flex-wrap gap-3">
        <button type="submit" class="app-btn-primary">Aplicar filtros</button>
        <a href="/components" class="app-btn-secondary">Limpar</a>
    </div>
</form>
