...
<body class="h-full bg-slate-50 text-slate-800 antialiased dark:bg-slate-950 dark:text-slate-100">
    ...
    <div class="app-floating-actions" aria-label="Acoes rapidas da pagina">
        <a href="/dashboard" class="app-floating-action hidden" data-up-button aria-label="Subir um nivel" title="Subir um nivel">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 19V5m0 0 6 6M12 5l-6 6"/>
            </svg>
        </a>
        <button type="button" class="app-floating-action app-floating-action--hidden" data-scroll-top aria-label="Voltar ao topo" title="Voltar ao topo">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
